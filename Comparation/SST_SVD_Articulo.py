...
detect_rule = ThreeSigmaWithLilliefors(frac_stable=0.3605200000438832 , 
                                       alpha=0.05, z=3.0, 
                                       fallback_mad=False,)
...
plt.title("Puntos en zona de chatter (d1 > lim_sup)")
